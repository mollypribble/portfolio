...
class Home extends React.Component {
    ...
    render () {
        ...
        return <div className="home-display">
                <video className={disableVideo} id="home-background-video" src={websitev2} typeof='video/mp4' autoPlay="true" loop="true" muted="true" playsInline="true" webkit-playsinline="true" poster={poster} />
