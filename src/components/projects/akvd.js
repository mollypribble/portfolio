        ...
        <div className="project-display">
            ...
            <div className="akvd-takeaways">
                ...
                <div className='akvd-takeaway'>
                    ...
                    <div className='akvd-text'>Lastly, Active View Data gave me ample opportunities to practice my presentation and communication skills. Throughout my internship, I regularly scheduled and lead status updates and feedback sessions with the rest of the UX group. My also mentors and co-workers often wanted to see demos or walkthroughs of Active View Data throughout the project, and I became practiced in explaining the concept of Active View Data and taking my audience through a typical user flow. My internship ended with a company-wide presentation and demo of the progress we'd made on Active View Data, where we generated a lot of interest and excitement about this new, relatively unknown project.</div>
                </div>
            </div>
