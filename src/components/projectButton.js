...
class ProjectButton extends React.Component {
    ...
    render () {
        return <button className={"proj-button " + "button-" + this.props.projNumber} alt={this.props.alt} onClick={(e) => this.clickAndBlur(e)} aria-label={"Project " + this.props.projNumber + " " + this.props.projName}>
