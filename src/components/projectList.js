    ...
    render () {
        ...
        return <div className="project-list-display">
                ...
                <div className='project-list'>
                    ...
                    <ReactButtonLink className={"proj-button-wrapper no-right"} proj={true} linkTo="/portfolio/projects/active-view-data" projName={"Active View Data"} projNumber={'2'} projDescription={"UX Design, Interaction Design, Prototyping, User Testing"} projRole={"Solo UX Designer"} onClick={(e) => this.props.handleNewProj(3)} />
