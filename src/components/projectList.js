    ...
    render () {
        ...
        return <div className="project-list-display">
                ...
                <div className='project-list'>
                    ...
                    <ReactButtonLink className={"proj-button-wrapper"} proj={true} linkTo="/portfolio/projects/active-view-data" projName={"Active View Data"} projNumber={'2'} projDescription={"UX Design, Interaction Design, Prototyping, User Testing"} onClick={(e) => this.props.handleNewProj(3)} />
                    ...
                    <ReactButtonLink className={"proj-button-wrapper"} proj={true} linkTo="/portfolio/projects/hold-the-code" projName={"Hold the Code"} projNumber={'4'} projDescription={"Communication Design, Project Management, Tech Ethics"} onClick={(e) => this.props.handleNewProj(5)} />
            </div>
        </div>
    }
